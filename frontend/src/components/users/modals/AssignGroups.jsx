...
function AssignGroups({ update, iasUser, close }) {
    ...
    return (
        <div className="modal-backdrop" >
            ...
            <div className="modal-frame" style={{ height: '55vh', width: '50vw', padding: '0' }}>
                <h2 style={{ marginBottom: '0', marginTop: '1rem', alignSelf: 'center', width: 'fit-content' }}>Assign Groups</h2>
                <hr style={{ margin: '0' }} />
