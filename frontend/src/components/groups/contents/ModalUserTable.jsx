...
import AssignUsers from "../modals/AssignUsers";
...
function ModalUserTable({ groupId }) {
    ...
    return (
        <div style={{ height: '44vh' }}>
            ...
            <hr />
            <div style={{ boxShadow: '1px 3px 5px gray', margin: '3px', borderRadius: '8px', overflowY: 'auto', height: '38vh' }}>
                {loading ? <Loading pos={'relative'} /> :
                    <table style={{ margin: '0', marginBottom: 'auto' }}>
                        <thead>
                            <tr>
                                <th>
